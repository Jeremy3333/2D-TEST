...
bin/mainWIN.exe: obj/mainWIN.o obj/cell.o obj/displaySDLWIN.o obj/vec2f.o obj/world.o
	g++ -o bin/mainWIN.exe obj/cell.o obj/mainWIN.o obj/displaySDLWIN.o obj/vec2f.o obj/world.o -L C:\SDL2-w64\lib -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lSDL2_ttf 
